            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small">{{ $total_sale_returns }} Return Penjualan</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small">Laba</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small">{{ $total_purchase_returns }} Return Pembelian</div>
                    </div>
                </div>
            </div>
        </div>
