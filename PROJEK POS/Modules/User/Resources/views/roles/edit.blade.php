            ...
            <div class="col-md-12">
                ...
                <form action="{{ route('roles.update', $role->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary">Update Peran <i class="bi bi-check"></i>
                        </button>
                    </div>
                    <div class="card">
                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="show_monthly_cashflow">Arus Kas Bulanan</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="edit_own_profile">Profile</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="print_barcodes">Print Barcode</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="create_quotation_sales">Penjualan dari Kuitansi</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="access_purchase_payments">Pembayaran</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="access_purchase_return_payments">Pembayaran</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
